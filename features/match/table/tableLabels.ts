...
export function targetingHint(kind: "playCard" | "break" | "attack" | "shipShot" | "shipTarget" | "ability" | null): string | null {
  ...
  if (kind === "ability") return "Choisissez une cible pour la capacité.";
