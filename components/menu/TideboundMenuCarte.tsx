      ...
      <div className={styles.stage}>
        ...
        */}
        <div className={styles.propTasse} aria-hidden>
          ...
          <Image src={MENU_CARTE_ASSETS.cafeCalme} alt="" width={718} height={338} sizes="14vw" draggable={false} className={styles.cafeCalme} />
          {/* Le café agité est posé SUR le calme, à la même place : la
              ride n'est qu'un fondu de l'un vers l'autre. */}
          <Image src={MENU_CARTE_ASSETS.cafeAgite} alt="" width={718} height={338} sizes="14vw" draggable={false} className={styles.cafeAgite} />
        </div>
