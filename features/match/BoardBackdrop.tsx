/**
 * Toile de fond immersive du plateau (`public/assets/board/board.webp`),
...
export function BoardBackdrop({ variant = "fixed" }: { variant?: "fixed" | "absolute" }) {
  return (
    <div aria-hidden className={`${variant === "fixed" ? "fixed" : "absolute"} inset-0 overflow-hidden`}>
      ...
      <img src="/assets/board/board.webp" alt="" draggable={false} className="h-full w-full select-none object-cover" />
      <div
