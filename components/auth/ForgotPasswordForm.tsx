...
export function ForgotPasswordForm({ onBackToLogin }: ForgotPasswordFormProps) {
  ...
  if (status === "sent") {
    return (
      <div className="flex flex-col gap-3 text-center">
        <h2 className="text-xl font-semibold text-[var(--tb-text-strong)] [font-family:var(--tb-font-display)]">Email envoyé</h2>
  ...
  return (
    <form action={handleSubmit} className="flex flex-col gap-3">
      <h2 className="text-xl font-semibold text-[var(--tb-text-strong)] [font-family:var(--tb-font-display)]">Mot de passe oublié</h2>
      <p className="text-sm text-[var(--tb-text-muted)]">On t&apos;envoie un lien pour en choisir un nouveau.</p>
