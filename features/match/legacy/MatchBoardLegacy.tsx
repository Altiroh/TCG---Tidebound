 ...
 */
/**
 * COPIE DE SAUVEGARDE de l'ancien `MatchBoard` (plateau 1672×941 mis à l'échelle
 ...
 */
export function MatchBoardLegacy({ initialState, onExit, botPlayerId, botDifficulty }: MatchBoardProps) {
